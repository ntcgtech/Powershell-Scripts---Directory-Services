...
$from = "DoNotReply@xx.com" 
$email1 = "neil.xx@xx.com"
$timeout = "60"
...
add-content $report  "<font face='tahoma' color='#003399' size='4'><strong>Active Directory Health Check Media.Corporatead.net</strong></font>" 
add-content $report  "</td>" 
...
$subject = "Active Directory Health Monitor Media.Corporatead.net" 
