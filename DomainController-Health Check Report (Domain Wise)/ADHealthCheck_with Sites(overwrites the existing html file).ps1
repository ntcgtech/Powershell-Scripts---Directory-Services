...
#new-item -path "E:\HC Script" -name "ADReport.htm" -ItemType "file"
}
$smtphost = "SMTP Address" 
$from = "activedirectoryhealthchecksreports@xx.com" 
$email1 = "xx@xx.com"
$timeout = "60"
...
$Site = $DC.Site
                Add-Content $report "<tr>"
if ( (Test-Connection -ComputerName $DC -Count 1 -ErrorAction SilentlyContinue) -or ($DC -like "ntcgtechdc04") -or ($DC -like "ntcgtechdc07")) {
